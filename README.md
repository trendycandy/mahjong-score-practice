...
- **점수표 연습 모드**: **연습 / 실전** 선택. 연습은 바둑판에서 단계를 고른다(자/친 × 론/쯔모 × 부수 계열 30·50·25·40·(20)·60/80/100·70/90/110 + 만관 이상 + 전체, 28단계) + 범위 조정 + 힌트 보기, 실전은 점수표 전 칸 무작위·힌트 없음. 점수를 입력하면 채점 + 암기 팁 해설(같은 부수 열, 같은 점수 칸). 틀린 칸은 세션 안에서 더 자주 나온다.
